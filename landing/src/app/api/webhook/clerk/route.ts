...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    return new NextResponse('Error occurred during webhook verification', { status: 400 });
  }
  ...
  if (eventType === 'user.created') {
    ...
    try {
      ...
      return new NextResponse('Internal server error processing user creation', { status: 200 });
    }
  } else {
